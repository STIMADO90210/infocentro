    ...
    <div class="mbr-testimonials mbr-section mbr-section-nopadding">
        <div class="container">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <h2 class=""><?php echo strtoupper($user[0]['nombre_user']) ?></h2> 
                <a href="imprimir_reg.php?id=<?php echo $id_user ?>" class="btn btn-black col-lg-offset-8"> Imprimir Registros</a>
                <table class="table table-bordered text-lg-center">
                    ...
                    <tr>                                                                                                                                                                                                                                                         
                         ...
                         <td><?php 
                               ...
                               echo strtoupper($reg[$i]['dia_visita']);
