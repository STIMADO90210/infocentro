...
//$vi=new visita();
//$v=$vi->leer_visita_id($motvis);
//if($v[0]['motivo']=="usar equipo"){
 //   $equipo[]['id']=$indice;
  //  $equipo[]['nombre']=$nomb;
 ?>
<!--<script>    
        alert('Usuario Se Registro Correctamente');
        window.location='tiempo_acceso.php';
</script> ---->
    <?php   
...
<script>    
        alert('Usuario Se Registro Correctamente');
        window.location='ultimoregistro.php';
</script>
    <?php
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="mes_nac">
                                        <?php for($m=0;$m<12;$m++){ ?>
                                        <option class="text-lg-left" value="<?php echo $m ?>"><?php echo strtoupper($mes[$m]) ?></option>
                                        <?php } ?>
                                    </select>
                                         </div>
                                   </div>   
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="discap"> 
                                        ...
                                        <?php   for($i=0;$i<sizeof($dis);$i++){  ?>                                       
                                           <option class="" value="<?php echo $dis[$i]['id_disc'] ?>"><?php echo strtoupper($dis[$i]['discapacida']) ?></option>                                        
                                        <?php } ?>                                                                                
                                    </select>                                    
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="indio">
                                        ...
                                        <?php   for($i=0;$i<sizeof($ind);$i++){  ?>                                       
                                           <option class="" value="<?php echo $ind[$i]['id_ind'] ?>"><?php echo strtoupper($ind[$i]['comunidad']) ?></option>                                        
                                        <?php } ?>                                                                                
                                    </select>                                    
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="motvis">                                        
                                        <?php   for($i=0;$i<sizeof( $vis);$i++){  ?>                                       
                                           <option class="" value="<?php echo  $vis[$i]['id_mot'] ?>"><?php echo  strtoupper($vis[$i]['motivo']) ?></option>                                        
                                        <?php } ?>                                                                                
                                    </select>                                    
                                </div>
                            </div>
