...
<section class="mbr-section" id="listado1" style="background-color: rgb(255, 255, 255); padding-top: 120px; padding-bottom: 120px;">
    ...
    <div class="mbr-testimonials mbr-section mbr-section-nopadding" id="recarga">
        ...
        <div class="container  ">
            ...
            <div class="jumbotron">
                <h1> <?php echo "<a class='letra-roja'>NICK</a> : ". strtoupper($c[$i]['nick']); ?></h1>
                <p class='small col-lg-offset-2'> <a class="text-danger">FECHA : </a> <?php echo strtoupper($c[$i]['fecha']) ?> --- <a class="text-danger">HORA : </a> <?php echo strtoupper($c[$i]['hora']) ?> </p>  
                ...
                <br>
                <br>
                <p class=" letra-azul">        <?php echo  strtoupper($c[$i]['comentario']) ?></p>
