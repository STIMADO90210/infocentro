                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="mes_nac">
                                        <option value="<?php echo  $meses ?>"><?php echo $mes[$meses+1] ?></option>
                                        <?php for($m=1;$m<12;$m++){ ?>
                                        <option class="text-lg-left" value="<?php echo $m ?>"><?php echo $mes[$m-1] ?></option>
                                        <?php } ?>
                                    </select>
                                         </div>
                                   </div>   
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                        //include 'clases/discap.php';
                                         ...
                                         $di=new discap();
                                         $d=$di->leer_discap_user($id);
                                         $nro_dis=$d[0]['disc_user']; 
                                         
                                         $pa=new discap();
                                         $p=$pa->leer_discap_id($nro_dis);
                                     ?> 
                                    ...
                                    <select class="form-control" name="discap"> 
                                        <?php if($nro_dis!=0)
                                                {
                                                ?>
                                        <option class="" value= "<?php echo $p[0]['id_disc'] ?>"><?php echo $p[0]['discapacida']; ?></option> 
                                                                                                       
                                                <?php   
                                                } else {
                                                    ?>
                                                    <option class="" value="0"> NO APLICA </option>
                                                    <?php
                                                }
